    ...
    <MainTemplate>
      <Container>
        <GenericHTML>
          ...
          <p>
            Opa! A página que você está tentando encontrar não existe. Talvez
            ela tenha tirado férias, resolvido explorar o universo ou se perdido
            em algum lugar entre dois buracos negros. 🌌
          </p>
